...
<body>
    <table class="table">
        ...
        <tr>
            ...
            <td>
                <a href="ComplaintUpdate.jsp?id=<%= complaintDto.getId()%>" class="btn btn-info">Update</a>
                <a href="ComplaintDelete.jsp?id=<%= complaintDto.getId()%>" class="btn btn-danger">Delete</a>
            </td>
        </tr>
        <% } %>
        </tbody>
